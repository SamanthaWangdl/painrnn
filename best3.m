...
for k=1:87
        ...
        sel=find(ismember(train_dataclass,'B1')|ismember(train_dataclass,'P3'));
        sel2=find(ismember(test_dataclass,'B1')|ismember(test_dataclass,'P3'));
        ...
        trainfeature=activations(netall3{1,k},train_data,2,'MiniBatchSize',40);
        testfeature=activations(netall3{1,k},test_data,2,'MiniBatchSize',40);
      for t=1:3440
